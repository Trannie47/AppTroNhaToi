    ...
    return ChangeNotifierProvider(
      ...
      child: Consumer<CapNhatThanhToanViewModel>(
        builder: (context, vm, child) {
          bool isPaidFull = vm.conThieu <= 0; // Kiểm tra xem đã thanh toán đủ hay chưa
                ...
                children: [
                  ...
                  Container(
                    ...
                    child: Column(
                      crossAxisAlignment: CrossAxisAlignment.start,
                      children: [
                        const Text("Tổng tiền còn thiếu:", style: TextStyle(fontSize: 12, color: Colors.black54)),
                        ...
                        Expanded(
                          child: ElevatedButton(
                            ...
                            child: vm.isLoading
                                ...
                                : const Text("XÁC NHẬN THU TIỀN", style: TextStyle(color: Colors.white, fontWeight: FontWeight.bold, fontSize: 12)),
                          ),
                        ),
                      ],
                    ),
