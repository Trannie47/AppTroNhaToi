...
class _TaoHoaDonPageState extends State<TaoHoaDonPage> {
  ...
  void initState() {
    ...
    _currentThangNam = widget.thangNam ??
      ...
      child: Consumer<HoadonPhongProvider>(
        builder: (context, hoaDonProvider, child) {
          return ChangeNotifierProvider(
            create: (_) {
              final vm = TaoHoaDonPhongPageViewModel(hoaDonProvider: hoaDonProvider);
              vm.fetchInitData(widget.phongId, _currentThangNam);
              return vm;
            },
            child: Consumer<TaoHoaDonPhongPageViewModel>(
              builder: (context, vm, child) {
                final countPending = vm.listContracts.where((hd) => !hd.isAlreadyBilled).length;
                  ...
                  body: vm.isLoading
                    ...
                    child: Column(
                      children: [
                        ...
                        if (vm.isAllContractsBilled && vm.isTinhTienHopDong)
                          InkWell(
                            onTap: () async {
                            ...
                            child: Container(
                              ...
                              child: Row(
                                children: [
                                  const Icon(Icons.info_outline, color: Color(0xff8D6E63), size: 20),
                                  ...
                                  Container(
                                    ...
                                    child: const Row(
                                      children: [
                                        Text("Xem", style: TextStyle(fontSize: 12, fontWeight: FontWeight.bold, color: Color(0xff5D4037))),
                                        SizedBox(width: 4),
                                        Icon(Icons.arrow_forward_ios, size: 10, color: Color(0xff5D4037)),
                                      ],
                                    ),
                                  ),
                                ],
                        ...
                        Container(
                          ...
                          child: Row(
                            mainAxisAlignment: MainAxisAlignment.spaceBetween,
                            children: [
                              const Text("Ngày lập hóa đơn:", style: TextStyle(fontSize: 13, fontWeight: FontWeight.w600, color: Colors.black87)),
                              InkWell(
                                onTap: () async {
                                  ...
                                  if (picked != null) vm.setNgayLap(picked);
                                },
                                child: Container(
                              ...
                              if (vm.isChotDienNuoc && vm.canCreateDienNuoc) ...[
                                ...
                                Container(
                                  ...
                                  child: Row(
                                    mainAxisAlignment: MainAxisAlignment.spaceBetween,
                                    children: [
                                      const Text("Tổng Điện + Nước cả phòng:", style: TextStyle(fontSize: 13, fontWeight: FontWeight.w600)),
                                      Text(formatMoney(vm.tongTienDienNuocPhong), style: const TextStyle(fontSize: 14, fontWeight: FontWeight.bold, color: Color(0xff2E7D32))),
                                    ],
                                  ),
                                ),
                              ] else ...[
                        ...
                        _buildCardSection(
                          ...
                          trailing: Switch(
                            ...
                            activeColor: const Color(0xff2E7D32),
                            onChanged: (val) => vm.toggleTinhTienHopDong(val),
                          ),
                          child: Column(
                            crossAxisAlignment: CrossAxisAlignment.start,
                            children: [
                                  ...
                                  return Container(
                                    ...
                                    child: Column(
                                      ...
                                      children: [
                                        ...
                                        Row(
                                          children: [
                                            const Text("Tiền phòng:", style: TextStyle(fontSize: 13, fontWeight: FontWeight.w500)),
                                            const SizedBox(width: 10),
                                            Expanded(
                                              child: SizedBox(
                                                height: 38,
                                                child: TextField(
                                                  controller: hd.txtTienPhongCtrl,
                                        ...
                                        if (hd.danhSachXe.isNotEmpty) ...[
                                          ...
                                          const Text("Phương tiện đăng ký:", style: TextStyle(fontSize: 12, fontWeight: FontWeight.w600)),
                                          const SizedBox(height: 6),
                                          ...hd.danhSachXe.map((xe) => Padding(
                                            padding: const EdgeInsets.symmetric(vertical: 2),
                                            child: InkWell(
                                              onTap: () => vm.toggleVehicle(xe, !xe.isEnabled),
                                              child: Row(
                                                children: [
                                                  SizedBox(
                                                    width: 24,
                                                    ...
                                                    child: Checkbox(
                                                      value: xe.isEnabled,
                                                      activeColor: const Color(0xff2E7D32),
                                                      onChanged: (val) => vm.toggleVehicle(xe, val ?? true),
                                                    ),
                                                  ),
                                                  const SizedBox(width: 8),
                                                  Expanded(
                                                    child: Text(
                                                      ...
                                                      style: TextStyle(
                                                        fontSize: 12,
                                                        color: xe.isEnabled ? Colors.black87 : Colors.grey,
                                                        decoration: xe.isEnabled ? null : TextDecoration.lineThrough,
                                                      ),
                                                    ),
                                                  ),
                                                  Text(
                                        ...
                                        TextField(
                                          ...
                                          decoration: InputDecoration(
                                            hintText: "Nhập ghi chú riêng cho hóa đơn này...",
                                        ...
                                        Row(
                                          mainAxisAlignment: MainAxisAlignment.spaceBetween,
                                          children: [
                                            const Text("Tạm tính cá nhân:", style: TextStyle(fontSize: 12, fontWeight: FontWeight.bold)),
                                            Text(
                                              formatMoney(hd.tamTinhCaNhan),
                                              style: const TextStyle(
                                                fontWeight: FontWeight.bold,
                                                fontSize: 13,
                                                color: Color(0xff2E7D32),
                        ...
                        if (vm.isTinhTienHopDong && !vm.isAllContractsBilled)
                          _buildCardSection(
                            title: "3. Dịch vụ phát sinh thêm (Mỗi Hợp đồng)",
                            child: Column(
                              children: [
                                _buildPriceRow("Tiền dịch vụ thêm / khách", vm.txtTienDichVuKhac, () => vm.notifyUI()),
                              ],
                            ),
                          ),
                  ...
                  bottomNavigationBar: Container(
                    ...
                    child: Row(
                      children: [
                        ...
                        ElevatedButton(
                          onPressed: (vm.isLoading || (!vm.isChotDienNuoc && !vm.isTinhTienHopDong))
                              ? null
                              : () async {
                            ...
                            if (mounted) {
                              if (success) {
                                ScaffoldMessenger.of(context).showSnackBar(
                                  const SnackBar(
                                    content: Text("Tạo hóa đơn đợt này thành công!"),
                                ...
                                ScaffoldMessenger.of(context).showSnackBar(
                                  SnackBar(
                                    content: Text(vm.errorMessage ?? "Tạo hóa đơn thất bại!"),
  ...
  Widget _buildCardSection({required String title, required Widget child, Widget? trailing}) {
    return Container(
      ...
      child: Column(
        ...
        children: [
          Row(
            mainAxisAlignment: MainAxisAlignment.spaceBetween,
            children: [
              Expanded(child: Text(title, style: const TextStyle(fontWeight: FontWeight.bold, fontSize: 13, color: Color(0xff2E7D32)))),
    ...
    return Column(
      ...
      children: [
        ...
        Row(
          mainAxisAlignment: MainAxisAlignment.spaceBetween,
          children: [
            Text("Tiêu thụ: $suDung | Thành tiền:", style: const TextStyle(fontSize: 12, color: Colors.black54)),
            Text(
        ...
        InkWell(
          ...
          child: Container(
            ...
            child: Text(
              imageFile != null ? "Đã đính kèm ảnh bằng chứng" : "Tải ảnh đồng hồ làm bằng chứng",
              style: TextStyle(fontSize: 12, color: imageFile != null ? Colors.green.shade700 : Colors.grey.shade700),
            ),
          ),
        ),
      ],
  ...
  Widget _buildMoneyInput(String label, TextEditingController ctrl, VoidCallback onChanged) {
    return Column(
      crossAxisAlignment: CrossAxisAlignment.start,
      children: [
        Text(label, style: const TextStyle(fontSize: 11, color: Colors.grey)),
  ...
  Widget _buildPriceRow(String label, TextEditingController ctrl, VoidCallback onChanged) {
    return Row(
      children: [
